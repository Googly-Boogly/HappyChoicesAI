...
def introduction_prompt_gen() -> PromptTemplate:
    ...
    return PromptTemplate(
        template="""You are a world renowned AI ethicist. You have been tasked with generating the purpose and scope of the thought experiments.
...
def common_themes_prompt() -> PromptTemplate:
    ...
    """
    return PromptTemplate(
        template="""You are a world renowned AI ethicist. You have been tasked with identifying and describing common themes from all the thought experiments and any overarching trends or significant findinds.
...
def historical_examples_prompt_summary_prompt() -> PromptTemplate:
    ...
    """
    return PromptTemplate(
        template="""You are a world renowned AI ethicist. You have been tasked with summarizing the historical examples used and their relevance to the thought experiments.
...
def insights_gleamed_from_thought_experiments() -> PromptTemplate:
    ...
    """
    return PromptTemplate(
        template="""You are a world renowned AI ethicist. You have been tasked with generating key insights gleaned from all the thought experiments.
...
def conclusion_summary() -> PromptTemplate:
    ...
    """
    return PromptTemplate(
        template="""You are a world renowned AI ethicist. You have been tasked with creating a comprehensive conclusion based on all provided sections.
...
def lessons_learned_prompt() -> PromptTemplate:
    ...
    """
    return PromptTemplate(
        template="""You are a world renowned AI ethicist. You have been tasked with generating lessons learned from the thought experiments.
