...
class TestProposeAllActions(unittest.TestCase):
    ...
    def test_correct_json_output(self, mock_create_prompt_template, mock_llm):
        # Arrange
    ...
    @patch('HappyChoicesAI.perform_thought_experiment.llm')
    @patch('HappyChoicesAI.perform_thought_experiment.create_prompt_template_propose_actions')
    def test_json_without_actions_key(self, mock_create_prompt_template, mock_llm):
        # Arrange
        mock_output = MagicMock()
    ...
    @patch('HappyChoicesAI.perform_thought_experiment.llm')
    @patch('HappyChoicesAI.perform_thought_experiment.create_prompt_template_propose_actions')
    def test_empty_output(self, mock_create_prompt_template, mock_llm):
        # Arrange
        mock_output = MagicMock()
        mock_output.content = ''
