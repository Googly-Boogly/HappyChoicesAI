...
from HappyChoicesAI.summarize_result import common_themes_prompt, create_markdown_format_for_all, \
    run_common_themes_prompt, run_create_markdown_format_for_all
...
class TestRunCommonThemes(unittest.TestCase):
    ...
    def test_run_common_themes_prompt(self, mock_invoke_with_retry, mock_get_instance2, mock_get_instance,
        ...
        result = run_common_themes_prompt()
