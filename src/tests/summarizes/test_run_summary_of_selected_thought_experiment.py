...
#     run_create_markdown_format_for_all, run_summary_of_selected_thought_experiment, \
...
#
#
# class TestRunSummarySelectedTE(unittest.TestCase):
#
#     def setUp(self):
#         self.state = Mock()
...
#
#         result = run_summary_of_selected_thought_experiment()
#
