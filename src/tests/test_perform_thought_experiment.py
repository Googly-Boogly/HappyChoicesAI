...
class TestPerformThoughtExperiments(unittest.TestCase):
    ...
    def test_propose_all_actions(self, mock_get_instance, mock_create_prompt_template):
        # Arrange
    ...
    @patch('HappyChoicesAI.perform_thought_experiment.FileState.get_instance')
    @patch("HappyChoicesAI.perform_thought_experiment.create_prompt_template_propose_actions")
    def test_propose_all_actions_malformed_json(self, mock_create_prompt_template, mock_get_instance):
        # Arrange
        mock_output = MagicMock()
        mock_output.content = '{"actions": ["action1", "action2", "action3"'
    ...
    @patch('HappyChoicesAI.perform_thought_experiment.FileState.get_instance')
    @patch("HappyChoicesAI.perform_thought_experiment.create_prompt_template_propose_actions")
    def test_propose_all_actions_json_without_actions_key(self, mock_create_prompt_template, mock_get_instance):
        # Arrange
        mock_output = MagicMock()
    ...
    @patch('HappyChoicesAI.perform_thought_experiment.FileState.get_instance')
    @patch("HappyChoicesAI.perform_thought_experiment.create_prompt_template_propose_actions")
    def test_propose_all_actions_empty_output(self, mock_create_prompt_template, mock_get_instance):
        # Arrange
        mock_output = MagicMock()
        mock_output.content = ''
    ...
    @patch('HappyChoicesAI.perform_thought_experiment.FileState.get_instance')
    def test_analyze_parallels(self, mock_get_instance, mock_get_analyze_parallels_prompt):
        # Arrange
        mock_output = MagicMock()
    ...
    @patch('HappyChoicesAI.perform_thought_experiment.FileState.get_instance')
    def test_analyze_criteria_changes(self, mock_get_instance, mock_get_analyze_criteria_changes_prompt):
        # Arrange
        mock_output = MagicMock()
    ...
    @patch('HappyChoicesAI.perform_thought_experiment.FileState.get_instance')
    def test_analyze_percentage_changes(self, mock_get_instance, mock_get_analyze_percentage_changes_prompt):
        # Arrange
        mock_output = MagicMock()
    ...
    @patch('HappyChoicesAI.perform_thought_experiment.FileState.get_instance')
    def test_analyze_proxies_impact(self, mock_get_instance, mock_get_analyze_proxies_impact_prompt):
        # Arrange
        mock_output = MagicMock()
    ...
    @patch('HappyChoicesAI.perform_thought_experiment.FileState.get_instance')
    def test_quantify_proxies(self, mock_get_instance, mock_get_quantify_proxies_prompt):
        # Arrange
        mock_output = MagicMock()
    ...
    @patch('HappyChoicesAI.perform_thought_experiment.FileState.get_instance')
    def test_summarize_thought_experiment(self, mock_get_instance, mock_get_summarize_thought_experiment_prompt):
        # Arrange
        mock_output = MagicMock()
